...
export const experiences = [
  ...
  },
  {
    ...
    tech: ["React", "MySQL", "Heroku", "Web Hosting", "Computer Hardware"],
    logo: "DD",
...
export const apps = [
  {
    ...
    video: "/images/Video Project 1.mp4",
    image: null,
    ctaType: "modal",
    features: [
      "Self-hosted production deployment on self build server using Raspberry Pi, NGINX, SSL, and PM2 cluster mode to utilize all 4 CPU cores to handle a higher user load",
